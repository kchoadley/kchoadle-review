...
public class SortDemo extends Applet {
        ...
        private String bubble = "  Bubble Sort  ";
        private String selection = "  Selection Sort  ";
        private String merge = "  Merge Sort  ";
        private String insertion = "  Insertion Sort  ";
        private String quick = "  Quick Sort  ";
        private String heap = "  Heap Sort  ";
        ...
        public void init() {
                ...
                choiceBtn.addItem(bubble);
                choiceBtn.addItem(selection);
                choiceBtn.addItem(insertion);
                choiceBtn.addItem(merge);
                choiceBtn.addItem(quick);
                choiceBtn.addItem(heap);
